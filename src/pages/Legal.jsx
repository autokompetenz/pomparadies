...
Hébergeur : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
      ...
      sections: [
        {
          ...
          text: 'Le responsable du traitement des données est ANIMAL CONCEPT SRL. Pour toute question concernant vos données, contactez-nous par email.',
        },
        {
    ...
    },
    {
      ...
      sections: [
        {
          sub: '1. Objet',
          text: 'Les présentes CGV régissent la réservation et l\'achat de chiots auprès d\'ANIMAL CONCEPT SRL. Elles s\'appliquent à toute réservation effectuée via le site animalconceptsrl.com.',
        },
        {
          sub: '2. Réservation',
        ...
        },
        {
          ...
          text: 'Le chiot est remis à partir de l\'âge de 8 semaines révolues, conformément à la législation sur la protection animale (loi du 14 août 1986). Un carnet de santé, les vaccins à jour, la puce électronique et le certificat de bonne santé vétérinaire sont fournis.',
        },
        {
        ...
        {
          sub: '10. Litiges',
          text: 'Tout litige relève du droit belge et de la compétence exclusive des tribunaux de l\'arrondissement de Luxembourg. En cas de litige, une solution amiable sera recherchée avant toute action judiciaire.',
        },
        {
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, VS`,
    },
    {
      ...
      sections: [
        { sub: '1. Verwerkingsverantwoordelijke', text: 'De verwerkingsverantwoordelijke is ANIMAL CONCEPT SRL. Neem per e-mail contact met ons op voor vragen over uw gegevens.' },
    ...
    },
    {
      ...
      sections: [
        { sub: '1. Toepasselijkheid', text: 'Deze voorwaarden regelen de reservering en aankoop van puppy\'s bij ANIMAL CONCEPT SRL. Ze zijn van toepassing op elke reservering via animalconceptsrl.com.' },
        ...
        { sub: '7. Levering van de puppy', text: 'De puppy wordt geleverd vanaf de leeftijd van 8 weken, overeenkomstig de dierenwelzijnswetgeving (wet van 14 augustus 1986). Een gezondheidsboekje, up-to-date vaccinaties, microchip en veterinair gezondheidscertificaat worden meegegeven.' },
        ...
        { sub: '10. Geschillen', text: 'Geschillen vallen onder het Belgisch recht en de exclusieve bevoegdheid van de rechtbanken van het arrondissement Luxemburg. Bij een geschil wordt eerst een minnelijke schikking gezocht.' },
...
Hosting : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA`,
    },
    {
      ...
      sections: [
        { sub: '1. Data Controller', text: 'The data controller is ANIMAL CONCEPT SRL. For any questions regarding your data, contact us by email.' },
    ...
    },
    {
      ...
      sections: [
        { sub: '1. Scope', text: 'These terms govern the reservation and purchase of puppies from ANIMAL CONCEPT SRL. They apply to any reservation made via animalconceptsrl.com.' },
        ...
        { sub: '7. Puppy Handover', text: 'The puppy is handed over at a minimum of 8 weeks of age, in accordance with animal welfare legislation (law of August 14, 1986). A health record, up-to-date vaccinations, microchip, and veterinary health certificate are provided.' },
        ...
        { sub: '10. Disputes', text: 'Any dispute falls under Belgian law and the exclusive jurisdiction of the courts of the Luxembourg district. An amicable solution will be sought before any legal action.' },
